...
def ensure_playlist(youtube, title="Learn Thai Phrases for Beginners | Velocity Thai", description="All thai phrases videos in one playlist. 🇹🇭 Learn Thai with Velocity Thai!"):
